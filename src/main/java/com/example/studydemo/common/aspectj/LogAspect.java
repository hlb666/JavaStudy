package com.example.studydemo.common.aspectj;
...
public class LogAspect {
    ...
    //    @Pointcut("@annotation(com.example.studydemo.common.annotation.OperationLog)")
    @Pointcut("execution(public * com.example.studydemo.service..*.*(..))")
